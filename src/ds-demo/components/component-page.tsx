  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="mb-8">
        <h2 className="text-sm font-medium text-foreground-weak uppercase tracking-wider mb-3">Preview</h2>
      ...
      {entry.code && (
        <section className="mb-8">
          <h2 className="text-sm font-medium text-foreground-weak uppercase tracking-wider mb-3">Usage</h2>
          <pre className="rounded-lg border border-border-weak bg-background p-4 text-sm font-normal text-foreground-weak overflow-x-auto">
      ...
      {entry.props && entry.props.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-medium text-foreground-weak uppercase tracking-wider mb-3">Props</h2>
